...
class AlmtKTPAdapter extends TypeAdapter<AlmtKTP> {
  @override
  final int typeId = 4;

  @override
  AlmtKTP read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, AlmtKTP obj) {
    writer
      ..writeByte(17)
      ..writeByte(0)
      ..write(obj.nik)
...
_$_AlmtKTP _$$_AlmtKTPFromJson(Map<String, dynamic> json) => _$_AlmtKTP(
...
Map<String, dynamic> _$$_AlmtKTPToJson(_$_AlmtKTP instance) =>
    <String, dynamic>{
      'nik': instance.nik,
      'nama': instance.nama,
